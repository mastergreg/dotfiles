...
if exists("syntax_on")
    ...
    highlight Identifier          guifg=#8db6cd ctermfg=74                            gui=none cterm=none
    ...
    highlight PMenu               guifg=#e0eee0 ctermfg=194 guibg=#607b8b ctermbg=67  gui=none cterm=none
    highlight PMenuSbar           guifg=#e0eee0 ctermfg=194 guibg=#607b8b ctermbg=67  gui=none cterm=none
    highlight PMenuSel            guifg=#e0eee0 ctermfg=194 guibg=#006400 ctermbg=22  gui=none cterm=none
    highlight PMenuThumb          guifg=#e0eee0 ctermfg=194 guibg=#006400 ctermbg=22  gui=none cterm=none
